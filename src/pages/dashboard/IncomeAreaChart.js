...
const IncomeAreaChart = ({ slot }) => {
  ...
  useEffect(() => {
    const fetchExpenseData = async () => {
      try {
        ...
        const response1=await axios.get('http://localhost:3002/api/v1/get-incomes?user_id=6609b5b50b915f3b2267ad0b')
  ...
  useEffect(() => {
    setSeries([
      ...
      {
        name: 'Incomes',
        data: slot === 'month' ? monthlyIncome : [11, 32, 45, 32, 34, 52, 41]
      }
    ]);
  }, [slot]);
